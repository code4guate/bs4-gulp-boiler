...
// Get all the css from vendors and later deligate which ones we want to include in our build
gulp.task('vendorcss', function(){
    var filterSCSS = filter('**/*.css', { restore: true });
...
gulp.task('default', ['bower', 'vendorjs', 'vendorfonts', 'vendorcss', gulpIf(fs.existsSync('app/scss/libs/bootstrap-sass'), 'dirExists', 'vendorscss'), 'sass']);
